  ...
  return (
    <div
      ...
      style={{
        ...
        borderColor: 'rgba(232,217,176,0.1)',
      }}
    >
      {/* Móvil: texto corto */}
      <p className="block md:hidden text-[10px]" style={{ color: 'rgba(232,217,176,0.45)' }}>
        Arrastra para mirar · Toca los puntos para navegar
      </p>
      {/* Desktop: texto completo */}
      <p className="hidden md:block text-[11px] whitespace-nowrap" style={{ color: 'rgba(232,217,176,0.45)' }}>
