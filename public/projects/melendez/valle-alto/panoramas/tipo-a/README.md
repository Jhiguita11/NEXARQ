# Panoramas — Valle Alto / Apartamento Tipo A

Coloca aqui las imagenes equirectangulares 360 del Apartamento Tipo A.

Este tour corresponde al modelo de mayor area del proyecto Valle Alto (Constructora Melendez).
...
La funcion PANO() de tipo-a usa el prefijo:
  /projects/melendez/valle-alto/panoramas/tipo-a/
